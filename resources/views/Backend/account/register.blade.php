        ...
        <form action="{{ route('register.create') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="name" name="name"
                    class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring focus:ring-slate-400 @error('name') is-invalid @enderror"
            ...
            <div class="mb-6">
                <label for="password_confirmation" class="block text-slate-700 font-medium mb-2">Confirm
                    Password</label>
                <input type="password" id="password_confirmation" name="password_confirmation"
                    class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring focus:ring-slate-400 @error('password_confirmation') is-invalid @enderror"
            ...
            <button type="submit"
                class="w-full px-4 py-2 bg-slate-800 text-white font-bold rounded-lg hover:bg-slate-700 transition">Register</button>
        </form>
        <p class="text-center text-slate-600 mt-4">Already have an account? <a href="{{ route('login.index') }}"
